...
MySQL - 5.5.5-10.4.25-MariaDB : Database - procurement_tracking
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`procurement_tracking` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `procurement_list`(`id`,`description`,`amount`,`supplier`,`added_on`,`status`) values (1,'Chair',15000,1,'2022-11-03 14:39:50','To Receive');
